...
try:
    ...
    st.error("The TESPy model did not solve for the current inputs.")
    st.caption("Most common causes are pressure over-specification, an unsupported Python version for TESPy, or an infeasible steam state.")
    st.exception(e)
    st.stop()
